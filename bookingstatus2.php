...
?>
    ...
    <body>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle active" data-toggle="dropdown">Booking Status</a>
                                <div class="dropdown-menu">
        ...
        <?php
        include 'connect.php';
        $query = "SELECT * FROM `offerbook` WHERE `uname`='$name' AND status!='Delete'";
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if ($row['status'] == "Payment Confirmed") {
                            echo "<form action='#' method=post><button value='" . $row['id'] . "' class='btn btn-danger' name=delete disabled>Refund & Cancel</button></form></td>";
                        } else {
                            echo "<form action='#' method=post><button value='" . $row['id'] . "' class='btn btn-danger' name=delete>Refund & Cancel</button></form></td>";
                        }
                        ?>
                    <td><?php
        ...
        <?php
            if (isset($_POST["delete"])) {
                $del = $_POST["delete"];
                $dele = "UPDATE `offerbook` SET `status`= 'Delete' WHERE `id`='$del'";
