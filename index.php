            ...
            <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto">
                        ...
                        <a href="#location1" class="nav-item nav-link">Washing Points</a>
                        <a href="register.php" class="nav-item nav-link">Register</a>
                        <a href="Login.php" class="nav-item nav-link">Login</a>
                    </div>
                    <div class="ml-auto">
                        <a class="btn btn-custom" href="Login.php">Get Appointment</a>
                    </div>
                </div>
            </nav>
        </div>
            ...
            <div class="owl-carousel">
                <div class="carousel-item">
                    ...
                    <div class="carousel-text">
                        ...
                        <a class="btn btn-custom" href="Login.php">Explore More</a>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="about-content">
                            ...
                            <a class="btn btn-custom" href="Login.php">Learn More</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <p>Thorough hand wash including high pressure cleaning · Wheel rim cleaning and rim sealing ·
                                Removal of tar, insects and rust film · Polish and seal the vehicle.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <p>Create a homemade car freshener with one cup of baking soda and five drops of your favorite essential oil.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <p>Widely demanded in commercial place, these Car Vacuum Cleaner are light in weight and easy to install.
                                Moreover, we ensure safe delivery of these cleaners.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <h3>Seats Washing</h3>
                            <p>Cleaning your car seats is important to keep them stain- and odour-free.
                                Use the surface cleaning process given here to do it efficiently.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <h3>Window Wiping</h3>
                            <p>Wipe the windshield down with a clean, dry microfiber cloth to remove any dirt.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <h3>Wet Cleaning</h3>
                            <p>Your car is an investment! Detailing does more than merely clean your car. </p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            <i class="flaticon-car-wash"></i>
                            <h3>Oil Changing</h3>
                            <p>Every car is different, but most should have their oil changed every 10,000 km or 1 year.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            ...
                            <p>When the brake pedal is depressed, the fluid forces the brake calipers to compress the brake pads</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-4">
                        <div class="price-item featured-item">
                            <div class="price-header">
                                ...
                                <h2><span>Rs</span><strong>999</strong><span></span></h2>
                            </div>
                            <div class="price-body">
                                <ul>
                                    <li><i class="far fa-check-circle"></i>Seats Washing</li>
