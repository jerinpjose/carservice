                ...
                <div class="col-lg-8 ml-5">
                    <div class="location-form">
                        ...
                        <form action="#" method="post">
                            ...
                            <div class="control-group">
                                <input type="text" name="km" maxlength="4" onkeypress="return isNumberKey(event)" class="form-control" placeholder="Model" required="required" />
                            </div>
                            <div class="control-group">
                            ...
                            <div>
                                <button class="btn btn-custom" type="submit" name="submit">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
