...
?>
    ...
    <body>
        ...
        <?php
        include 'connect.php';
        $query = "SELECT * FROM `save` WHERE `uname`='$name' AND status ='1'";
        ...
        ?>
                <tr>
                    ...
                    <td>
                        ...
                        ?></td>
                    <td><a href="./savebook.php?id=<?php echo $row['id']; ?>"><button class='btn btn-danger'>BOOK</button></a></td>
                </tr>
            <?php
            }
            ?>
        ...
        <?php
            if (isset($_POST["delete"])) {
                $del = $_POST["delete"];
                $dele = "UPDATE `save` SET `status`= '0' WHERE `id`='$del'";
		...
		window.location.href='saveview.php';
            ...
            echo "<h1><br><br><br><br> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp
                ...
                Please save your car!!!  <br><br><br><br><br></h1>";
        }
