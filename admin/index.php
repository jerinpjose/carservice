...
<head>
    ...
    <title>Dashboard - CarBuddy Admin</title>
    <link rel="icon" href="assets/img/.png" type="image/x-icon" />
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card bg-primary text-white mb-4">
                                ...
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <a class="small text-white stretched-link" href="userdetails.php">View Details</a>
                                ...
                                <tbody>
                                    ...
                                    if ($sql) {
                                        while ($row = mysqli_fetch_array($sql)) {
                                            ...
                                            if ($row['status'] == 1) {
                                                echo ("<td><form action='#' method='post'><button type='submit' name='del' value=" . $row['id'] . " class='btn btn-danger'><i class='fa fa-trash' aria-hidden='true'></i>  Delete</button></form></td>");
                                            } else {
                                                echo ("<td><form action='#' method='post'><button type='submit' name='act' value=" . $row['id'] . " class='btn btn-success'><i class='fa fa-check' aria-hidden='true'></i>  Activate</button></form></td>");
                                            }
                                            echo ("
                                                </tr>
                                            ");
