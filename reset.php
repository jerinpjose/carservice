...
?>
        <!DOCTYPE html>
            ...
            <head>
                <meta charset="utf-8">
                <title>CAR BUDDY- Update Password</title>
                    ...
                    <div class="container">
                        <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                            ...
                            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                                ...
                                <div class="ml-auto">
                                    <a class="btn btn-custom" href="Login.php">Get Login</a>
                                </div>
                                <div class="ml-auto">
        ...
        <div class="col-lg-5">
            <div class="location-form">
                ...
                <form action="resetphp.php" method="POST">
                    ...
                    <div class="control-group">
                        <input type="email" class="form-control" placeholder="Email" name="gmail" required="required" />
                    </div>
