...
if (isset($_SESSION["id"])) {
    $query = "SELECT * FROM `register` WHERE uname='$name'";
                    ...
                    <div class=" location-form">
                        ...
                        <form action="#" method="post">
                            <div class="control-group">
                                <input type="text" name="regnum" class="form-control" disabled value="<?php echo $fetchRow['name']; ?>" required="required" />
                            </div>
                            <div class="control-group">
                                <input type="text" name="regnum" class="form-control" disabled value="<?php echo $fetchRow['mobile']; ?>" required="required" />
                            </div>
                            <div class="control-group">
                                <input type="text" name="email" class="form-control" disabled value="<?php echo $fetchRow['email']; ?>" required="required" />
                            </div>


                            <div class="control-group">
                                <input type="text" name="uname" class="form-control" disabled value="<?php echo $fetchRow['uname']; ?>" required="required" />
                            </div>
                            <div class="control-group">
                                <input type="password" name="password" class="form-control" value="<?php echo $fetchRow['password']; ?>" required="required" />
                            </div>



                            <div>
                                <button class="btn btn-custom" type="submit" name="submit">Update</button>
                            </div>
                        </form>
                    </div>
                </div>
...
if (isset($_POST['submit'])) {
    ...
    echo $upd = "UPDATE `register` SET `password`='$pass' WHERE `uname`='$name'";
    $result = mysqli_query($con, $upd);

    if ($result) {
        echo "Data Updated";
        echo "<script>alert('Data Updated')
        window.location.href='userupdates.php';</script>";
    } else {
